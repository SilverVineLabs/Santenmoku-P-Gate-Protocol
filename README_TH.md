...
> 🖥️ **เดโม UI แบบโต้ตอบสด**: สัมผัส 4-Stage Cognitive Intercept HUD ได้โดยตรงในเบราว์เซอร์:
> 👉 **[เปิด Santenmoku P-Gate HUD Demo (`docs/p-gate-demo.html`)](./docs/p-gate-demo.html)**
